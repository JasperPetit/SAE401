...
try {
    // Ajuste ici tes identifiants locaux si nécessaire (WAMP/XAMPP/MAMP ou Linux local)
    $host = 'localhost';
    $dbname = 'sae_colis'; // Remplace par le nom exact de ta base SQL
    $username = 'root';
    $password = ''; // Sur Ubuntu/Debian, met ton mot de passe si tu en as configuré un
    ...
    die("<div style='padding:20px; background:#fee2e2; color:#991b1b; font-family:sans-serif; border-radius:8px; border:1px solid #f87171; max-width:600px; margin:40px auto;'>
